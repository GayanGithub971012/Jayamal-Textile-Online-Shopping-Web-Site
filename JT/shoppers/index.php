...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover" style="background-image: url(images/bgimage_2.jpg);" data-aos="fade">
      <div class="container">
        <div class="row align-items-start align-items-md-center justify-content-end">
          <div class="col-lg-12 text-center  pt-5 pt-md-0">
            <h1 class="display-1">ORDER YOUR UNIFORM</h1>
            <div class="intro-text text-center">
              <p class="mb-4">Jayamal Textiles</p>
              <p>
                <a href="uniform.php" class="btn btn-sm btn-warning">Shop Now</a>
              </p>
            </div>
          </div>
        </div>
