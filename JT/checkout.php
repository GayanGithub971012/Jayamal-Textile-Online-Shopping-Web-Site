        ...
        <div class="row mb-5">
          <div class="col-md-12">
            <div class="border p-4 rounded" role="alert">
              Returning customer? <a href="" data-toggle="modal" data-target="#login">Click here</a> to login
            </div>
          </div>
        </div>
        <div class="row">
                ...
                <div class="p-3 p-lg-5 border">
                  ...
                  <div class="input-group w-75">
                    ...
                    <div class="input-group-append">
                      <button class="btn btn-dark btn-sm" type="button" id="button-addon2">Apply</button>
                    </div>
                  </div>
            ...
            <div class="row mb-5">
              <div class="col-md-12">
                ...
                <div class="p-3 p-lg-5 border">
                  ...
                  <div class="form-group">
                    <button class="btn btn-dark btn-lg py-3 btn-block" onclick="window.location='thankyou.html'">Place Order</button>
                  </div>
