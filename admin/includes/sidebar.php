...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  <!-- Brand Logo -->
  <a href="../JT/shoppers/index.php" class="brand-link text-center">
    <div class="image">
      <img src="assets/dist/img/titlelogo.png" class=" w-50 p-3" alt="User Image">
    </div>
    <span class="brand-text font-weight-light">JAYAMAL TEXTILES</span>
  </a>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a href="#" class="d-block">Nimmi Jayamali - Owner</a>
      </div>
    </div>
